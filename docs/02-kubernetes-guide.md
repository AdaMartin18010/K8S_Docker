...
- [Kubernetes 完整指南](#kubernetes-完整指南)
  - [目录](#目录)
  - [1. 核心架构](#1-核心架构)
    - [1.1 控制平面组件](#11-控制平面组件)
    - [1.2 1.30-1.32 重要新特性](#12-130-132-重要新特性)
  - [2. 基础资源](#2-基础资源)
    - [2.1 Pod 最佳实践 (2025版)](#21-pod-最佳实践-2025版)
    - [2.2 Deployment + HPA + PDB](#22-deployment--hpa--pdb)
    - [2.3 新版 Sidecar 容器 (1.29+)](#23-新版-sidecar-容器-129)
  - [3. 部署策略](#3-部署策略)
    - [3.1 金丝雀发布](#31-金丝雀发布)
  - [4. 存储管理](#4-存储管理)
    - [4.1 StorageClass 配置](#41-storageclass-配置)
    - [4.2 StatefulSet](#42-statefulset)
  - [5. 安全](#5-安全)
    - [5.1 Pod Security Standards (替代 PSP)](#51-pod-security-standards-替代-psp)
    - [5.2 RBAC 最小权限](#52-rbac-最小权限)
    - [5.3 NetworkPolicy](#53-networkpolicy)
  - [6. 可观测性](#6-可观测性)
    - [6.1 ServiceMonitor](#61-servicemonitor)
  - [7. 2025年重要更新](#7-2025年重要更新)
    - [7.1 已废弃/移除功能](#71-已废弃移除功能)
    - [7.2 Gateway API (替代 Ingress)](#72-gateway-api-替代-ingress)
  - [8. 关联代码示例](#8-关联代码示例)
  - [参考](#参考)
